...
export default function RecentWinner() {
  ...
  const handleDrag = (clientX: number) => {
    ...
    const maxThumbMove = rect.width - thumbWidth;
    ...
    content.scrollLeft = percent * maxScroll;
  };
        ...
        >
          ...
          {winners.map((winner) => (
            <div
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.backgroundColor = "#0f2575")
              }
              onMouseLeave={(e) =>
                (e.currentTarget.style.backgroundColor = "#0C1F56")
              }
            >
              {/* Game */}
              <div
