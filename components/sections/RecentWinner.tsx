      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ color: '#FFFFFF', fontSize: '14px', fontWeight: 700, fontFamily: 'Jost, Inter, sans-serif', letterSpacing: '0.08em', textTransform: 'uppercase',fontStyle:'bold' }}>GAME</span>
            <span style={{ color: '#FFFFFF', fontSize: '14px', fontWeight: 700, fontFamily: 'Jost, Inter, sans-serif', letterSpacing: '0.08em', textTransform: 'uppercase', fontStyle:'bold'}}>USERNAME</span>
            <span style={{ color: '#FFFFFF', fontSize: '14px', fontWeight: 700, fontFamily: 'Jost, Inter, sans-serif', letterSpacing: '0.08em', textTransform: 'uppercase',fontStyle:'bold' }}>TIME</span>
            <span style={{ color: '#FFFFFF', fontSize: '14px', fontWeight: 700, fontFamily: 'Jost, Inter, sans-serif', letterSpacing: '0.08em', textTransform: 'uppercase', textAlign: 'right',fontStyle:'bold' }}>PAYOUT</span>
          </div>
          ...
          {winners.map((winner) => (
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <span style={{ color: '#ffffff', fontSize: '14px', fontFamily: 'Inter, sans-serif', fontWeight: 600, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                  {winner.game}
                </span>
              </div>

              {/* Username */}
              <span style={{ color: '#FFFFFF', fontSize: '14px', fontFamily: 'Inter, sans-serif', fontWeight: 600 }}>
                {winner.username}
              </span>
              ...
              {/* Payout */}
              <span style={{ color: winner.positive ? '#00DD29' : '#7795E8', fontSize: '14px', fontFamily: 'Inter, sans-serif', fontWeight: 600, textAlign: 'right' }}>
                {winner.payout}
              </span>
            </div>
          ))}
